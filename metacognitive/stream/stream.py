...
class Stream:
    ...
    def output(self, log: str, user_id: str, type: str, ch_id: str, title: str, api_key: str, dev_id: str):
        ...
        for stream in self.streams:
            stream.output(log, user_id, type, ch_id, title, api_key, dev_id)
...
def output_stream(log: str, user_id: str = "levia", type: str = "info", ch_id: str = "", title: str = "", api_key: str = "", dev_id: str = ""):
    """
    ...
    _stream.output(log, user_id, type, ch_id, title, api_key, dev_id)
