...
3. Determine Source and Method:
   ...
   - Method:
     ...
     * If the argument with "defaultValue" is provided, the method should be "defaultValue"
   - Value:
     * The value of the argument.
     * If the argument with "defaultValue" is provided, the 'value' should be the same as "defaultValue"
