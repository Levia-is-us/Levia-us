def episodic_check_prompt(user_intent, context, plan):
    episodic_check_prompt = """You are an AI assistant tasked with analyzing user intents, contexts, and plan structures to determine if a given intent can be achieved using the provided plan. Your primary goal is to evaluate the feasibility of the plan and provide appropriate output based on your analysis.
