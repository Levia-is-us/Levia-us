...
- **Name**: Provide a concise summary of the type of external tool to be used (e.g., data extraction tool, visualization module, language processing engine). Do not include specific tool names.
- **Description**: Offer a general overview of the overall goal that this tool is intended to accomplish. Do not detail specific operations or individual actions; simply describe the broad purpose and expected outcome.
...
- **Name**: "Knowledge Documentation Generation and Upload"
